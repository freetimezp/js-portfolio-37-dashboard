        ...
        <aside id='sidebar' className='sidebar'>
            <ul className="sidebar-nav" id="sidebar-nav">
                ...
                <li className="nav-item">
                    ...
                    <ul className="nav-content collapse" id="components-nav"
                ...
                <li className="nav-item">
                    ...
                    <ul className="nav-content collapse" id="forms-nav"
                        data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="#">
                                <i className="bi bi-circle"></i>
                ...
                <li className="nav-item">
                    ...
                    <ul className="nav-content collapse" id="tables-nav"
                        data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="#">
                                <i className="bi bi-circle"></i>
                ...
                <li className="nav-item">
                    ...
                    <ul className="nav-content collapse" id="charts-nav"
                        data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="#">
                                <i className="bi bi-circle"></i>
                ...
                <li className="nav-item">
                    ...
                    <ul className="nav-content collapse" id="icons-nav"
                        data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="#">
                                <i className="bi bi-circle"></i>
